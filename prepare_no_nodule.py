...
class Sober_luna16(object):
    def __init__(self, workspace):
        ...
        self.df_annotations = pd.read_csv(self.workspace + "csv_files/no_nodule.csv")
        ...
        for fcount, img_file in enumerate(tqdm(self.ls_all_patients)):
            ...
            if mini_df.shape[0] > 0:  # some files may not have a nodule--skipping those
                ...
                for node_idx, cur_row in mini_df.iterrows():
                    ...
                    #cv2.imwrite(os.path.join(self.tmp_workspace, "jpg/%04d_%04d_%04d_%s.jpg"
                    #                         % (fcount, node_idx, i_z, cur_row["seriesuid"])), slice)
                    name = os.path.join(self.tmp_workspace, "jpg_no/%04d_%04d_%04d_%s_node.jpg"
                                        % (fcount, node_idx, i_z, cur_row["seriesuid"]))
                    cv2.imwrite(name, node[0])
                    cv2.imwrite(os.path.join(self.tmp_workspace, "jpg_no/%04d_%04d_%04d_%s_node_random.jpg"
                    ...
                    cv2.imwrite(os.path.join(self.tmp_workspace, "jpg_no/%04d_%04d_%04d_%s_node_45.jpg"
                                             % (fcount, node_idx, i_z, cur_row["seriesuid"])), mask_45)
                    cv2.imwrite(os.path.join(self.tmp_workspace, "jpg_no/%04d_%04d_%04d_%s_node_90.jpg"
                                             % (fcount, node_idx, i_z, cur_row["seriesuid"])), mask_90)
                    cv2.imwrite(os.path.join(self.tmp_workspace, "jpg_no/%04d_%04d_%04d_%s_node_left.jpg"
                                             % (fcount, node_idx, i_z, cur_row["seriesuid"])), flip_left_right)
                    cv2.imwrite(os.path.join(self.tmp_workspace, "jpg_no/%04d_%04d_%04d_%s_node_top.jpg"
                                             % (fcount, node_idx, i_z, cur_row["seriesuid"])), flip_top_bottom)
                    cv2.imwrite(os.path.join(self.tmp_workspace, "jpg_no/%04d_%04d_%04d_%s_o.jpg"
                                             % (fcount, node_idx, i_z, cur_row["seriesuid"])), nodule_mask)
                    np.save(os.path.join(self.tmp_workspace, "npy_no/base/%s_%04d_%04d_%04d.npy"
                                         % (cur_row["seriesuid"],fcount, node_idx,i_z)), node[0])
                    np.save(os.path.join(self.tmp_workspace, "npy_no/random/%s_%04d_%04d_%04d.npy"
                                         % (cur_row["seriesuid"], fcount, node_idx, i_z)),node[1])
                    np.save(os.path.join(self.tmp_workspace,"npy_no/base_45/%s_%04d_%04d_%04d.npy"
                                         % (cur_row["seriesuid"], fcount, node_idx, i_z)),mask_45)
                    np.save(os.path.join(self.tmp_workspace,"npy_no/base_90/%s_%04d_%04d_%04d.npy"
                                         % (cur_row["seriesuid"], fcount, node_idx, i_z)),mask_90)
                    np.save(os.path.join(self.tmp_workspace,"npy_no/left/%s_%04d_%04d_%04d.npy"
                                         % (cur_row["seriesuid"], fcount, node_idx, i_z)),flip_left_right)
                    np.save(os.path.join(self.tmp_workspace,"npy_no/top/%s_%04d_%04d_%04d.npy"
                                         % (cur_row["seriesuid"], fcount, node_idx, i_z)),flip_top_bottom)
                    np.save(os.path.join(self.tmp_workspace, "mask/%s_%04d_%04d_%04d_no_o.npy"
